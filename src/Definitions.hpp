...
#define HIT_SOUND_EFFECT_FILEPATH "Resources/audio/Hit.wav"
#define POINT_SOUND_EFFECT_FILEPATH "Resources/audio/Point.wav"
#define WING_SOUND_EFFECT_FILEPATH "Resources/audio/Wing.wav"
...
enum BirdState { STILL, FALLING , FLYING};

#define GRAVITY 450.0f
#define FLYING_SPEED 400.0f

#define FLYING_DURATION 0.20f

#define ROTATION_SPEED 200.f

enum GameStates { READY, PLAYING, GAME_OVER};

#define FLASH_SPEED 1500.0f

#define TIME_BEFORE_GAME_OVER_APPEARS 0.4f

#define HIGH_SCORE_FILE_FILEPATH "Resources/HighScore.txt"

#define BRONZE_MEDAL_SCORE 0
#define SILVER_MEDAL_SCORE 15
#define GOLD_MEDAL_SCORE 45
#define PLATINUM_MEDAL_SCORE 135